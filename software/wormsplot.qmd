---
title: "wormsplot"
description: For visualizing the movements of historical figures
categories: [R, ggplot2, DataViz]
image: wormsplot.svg
---

<img src="wormsplot.svg" align="right" width="200/"/>
...
You can install the development version of wormsplot from [GitHub](https://github.com/rimonim/wormsplot) with:
