...
The effect of both having an uncommon name is tiny, but does look to be slightly positive. The same goes for both boss and employee being men. Both being women, on the other hand, looks to be a huge advantage. The median estimate for that parameter is 0.28, which translates to a 32% odds increase. Conversely, bosses who are women are less likely than chance to have male employees. **Note:** Since there are more men than women in top executive positions overall, this does necessarily not mean that bosses who are women have mostly women as employees.
